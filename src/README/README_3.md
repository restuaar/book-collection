...
### XML dan XML by ID
#### XML
![Result XML using Postman](../img/XMLPostman.png)
#### XML by ID
![Result XML by ID using Postman](../img/XMLbyIDPostman.png)

### JSON dan JSON by ID
#### JSON
![Result JSON using Postman](../img/JSONPostman.png)
#### JSON by ID
![Result JSON by ID using Postman](../img/JSONbyIDPostman.png)
